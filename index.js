...
app.get('/', (req, res) => res.send('البوت شغال بأعلى استقرار وضد الحظر!'));
app.listen(3000);
...
// دالة تأخير لمنع حظر البوت أثناء البرودكاست
...
client.on('interactionCreate', async interaction => {
    ...
    try {
        ...
        if (commandName === 'kick') {
            ...
            return await interaction.reply(`👢 **تم طرد <@${member.id}>.**\nالسبب: ${reason}`);
        }
        ...
        if (commandName === 'ban') {
            ...
            return await interaction.reply(`🔨 **تم تبنيد <@${member.id}>.**\nالسبب: ${reason}`);
        }
        ...
        if (commandName === 'come') {
            ...
            try {
                ...
                return await interaction.reply(`❌ الخاص عند الشخص مغلق.`);
            }
        }
        ...
        // أمر برودكاست آمن ومحمي من الإغلاق والتهنيج
        if (commandName === 'bc') {
            ...
            await interaction.editReply('⏳ جاري إرسال البرودكاست بوضع الأمان لحماية البوت...');
            ...
            for (const [id, member] of members) {
                ...
                try {
                    ...
                    successCount++;
                    await sleep(300); // تأخير بسيط لحماية البوت من الـ Rate Limit
                } catch (err) {}
            }
            return await interaction.editReply(`✅ تم الانتهاء بنجاح! تم الإرسال إلى ${successCount} عضو والبوت مستقر.`);
        }
